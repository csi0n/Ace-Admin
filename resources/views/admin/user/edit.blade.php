            ...
            <div class="col-xs-12">
                ...
                {!! Form::open(array('route'=>['admin.user.update',$user['id']],'method'=>'patch','class'=>'form-horizontal','role'=>'form')) !!}
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('name',$user['name'],['class'=>'col-xs-10 col-sm-5','id'=>'form-field-1','placeholder'=>trans('labels.user.name')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::email('email',$user['email'],['class'=>'col-xs-10 col-sm-5','id'=>'form-field-2','placeholder'=>trans('labels.user.email')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                                                ...
                                                <td>
                                                    <div class="col-md-4">
                                                        <div class="md-checkbox">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input name="permission[]" value="{{$permission['id']}}" type="checkbox" class="ace" @if(in_array($permission['id'],$role['permissions'])) checked @endif>
