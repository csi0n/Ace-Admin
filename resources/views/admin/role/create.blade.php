    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open(array('route'=>['admin.role.store'],'method'=>'post','class'=>'form-horizontal','role'=>'form')) !!}
                    <div class="form-group">
                        {!! Form::label('name',trans('labels.role.name'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('name',null,['class'=>'col-xs-10 col-sm-5','id'=>'form-field-1','placeholder'=>trans('labels.role.name')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('slug',null,['class'=>'col-xs-10 col-sm-5','id'=>'form-field-2','placeholder'=>trans('labels.role.slug')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('description',trans('labels.role.description'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('description',null,['class'=>'col-xs-10 col-sm-5','id'=>'description','placeholder'=>trans('labels.role.description')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('level',trans('labels.role.level'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('level',null,['class'=>'col-xs-10 col-sm-5','id'=>'model','placeholder'=>trans('labels.role.level')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" id="form-field-2">
                            <div id="form-field-3">
                                <label>
                                    <input name="status" value="0" type="radio" class="ace" checked>
